    ...
    try {
        ...
        if (existingRequest) {
            return res
              .status(400)
              .json({
                message: "A friend request exits between you and this user",
              });
        }
...
export async function acceptFriendRequest(req, res) { 
    try {
        ...
        //$addToSet: adds elemnts to an araay only if they don not exists.
        ...
        res.status(200).json({ message: "Friends request accepetd" });
    } catch (error) {
